...
import fi.tieto.teco.demo.Ms1App;
import fi.tieto.teco.demo.config.SecurityBeanOverrideConfiguration;
import fi.tieto.teco.demo.domain.Car;
import fi.tieto.teco.demo.repository.CarRepository;
import fi.tieto.teco.demo.web.rest.errors.ExceptionTranslator;
...
import static fi.tieto.teco.demo.web.rest.TestUtil.createFormattingConversionService;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, Ms1App.class})
