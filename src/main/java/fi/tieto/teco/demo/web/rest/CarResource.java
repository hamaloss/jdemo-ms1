...
import fi.tieto.teco.demo.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link fi.tieto.teco.demo.domain.Car}.
 */
@RestController
@RequestMapping("/api")
public class CarResource {
    ...
    private static final String ENTITY_NAME = "ms1Car";
